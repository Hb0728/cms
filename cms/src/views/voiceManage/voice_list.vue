        ...
        <div class="text_view">
            ...
            <div class="text_list" style="width:100%">
                <el-row class="tab">
                    ...
                    <el-button type="success" size="default" style="position:absolute;right:20px;top: 20px;">添加音频项目
                    </el-button>
                </el-row>
                <el-row class="select_row" justify="space-between">
                    <div class="mb-3">
                        <el-select v-model="content_data.successionValue" class="m-2" placeholder="音频负责人" size="default">
