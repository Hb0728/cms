    ...
    <div class="text_view" style="margin-left:235px">
        ...
        <div class="text_list" style="width:100%">
            <el-row class="tab">
                ...
                <el-button type="success" size="default" style="position:absolute;right:24px;top: 20px;">添加音频项目
                </el-button>
            </el-row>
            <div style="padding:0 24px">
                <el-row class="select_row" justify="space-between">
                    <div class="mb-3">
                        <el-select v-model="content_data.successionValue" class="m-2" placeholder="音频负责人"
                            size="default">
