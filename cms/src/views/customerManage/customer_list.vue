    ...
    <div class="text_view" style="margin-left:235px">
        ...
        <div class="text_list" style="width:100%">
            <el-row class="tab">
                ...
                <el-button type="success" size="default" style="position:absolute;right:20px;top: 20px;">添加客户
                </el-button>
            </el-row>
            ...
            <div style="padding:0 24px">
                <el-table :header-cell-style="{ background: '#E6F1FF', color: '#666' }" :data="content_data.tableData"
                    ...
                    <el-table-column align="center" property="title" label="客户姓名" />
                    <el-table-column align="center" property="title" label="平台\单位" />
                    <el-table-column align="center" property="title" label="客户类型" />
                    <el-table-column align="center" property="title" label="手机号" />
                    <el-table-column align="center" property="name" label="微信号" />
                    <el-table-column align="center" property="name" label="对接情况">
                ...
                <el-row style="padding:24px 0" justify="space-between" align="middle">
